...
<html>
<head>
<!--google-site-verification: googlecdef9a93e2607a8b.html-->
<meta name="google-site-verification" content="zQ3rkENHVMjLkUjf4ahNQY1VgnuKsJr4FMXo9YsDvnE" />
...
s1.async=true;
s1.src='https://embed.tawk.to/5bae5a8f8a438d2b0cdfd500/default';
s1.charset='UTF-8';
...
<!-- End Alexa Certify Javascript -->  
	...
	<meta name="description" content="Zircash is an avant-garde cryptocurrency and a modern form of asset.">
	<meta name="keywords" content="ico token sale">
	<link rel="shortcut icon" href="{{asset('assets/images/logo/icon.png') }}" type="image/x-icon">
	<title>{{$gnl->title}} | {{$gnl->subtitle}} </title>
  <!-- Animation CSS -->
<link rel="stylesheet" href="{{asset('assets/frontlending/css/animate.css') }}">
<!-- Latest Bootstrap min CSS -->
<link rel="stylesheet" href="{{asset('assets/frontlending/bootstrap/css/bootstrap.min.css') }}">
<!-- Google Font -->
<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900" rel="stylesheet">
<!-- Font Awesome CSS -->
<link rel="stylesheet" href="{{asset('assets/frontlending/css/font-awesome.min.css') }}" >
<!-- ionicons CSS -->
<link rel="stylesheet" href="{{asset('assets/frontlending/css/ionicons.min.css') }}">
<!--- owl carousel CSS-->
<link rel="stylesheet" href="{{asset('assets/frontlending/owlcarousel/css/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{asset('assets/frontlending/owlcarousel/css/owl.theme.default.min.css') }}">
<!-- Magnific Popup CSS -->
<link rel="stylesheet" href="{{asset('assets/frontlending/css/magnific-popup.css') }}">
<link rel="stylesheet" href="{{asset('assets/frontlending/css/spop.min.css') }}">
<!-- Style CSS -->
<link rel="stylesheet" href="{{asset('assets/frontlending/css/style.css') }}">
<link rel="stylesheet" href="{{asset('assets/frontlending/css/responsive.css') }}">
<!-- Color CSS -->
<link id="layoutstyle" rel="stylesheet" href="{{asset('assets/frontlending/color/theme.css') }}">
		...
		<nav class="navbar navbar-expand-lg"> 
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="animation" data-animation="fadeInDown" data-animation-delay="1.6s"><a class="nav-link page-scroll nav_item" href="#">Team</a></li>
                    ...
                    <li class="animation" data-animation="fadeInDown" data-animation-delay="1.9s"><a class="nav-link nav_icon nav_item" title="Join Us on Telegram" href="https://t.me/zircash" target="_blank"><i class="fa fa-send"></i></a></li>
                 </ul>
                <ul class="navbar-nav nav_btn align-items-center">
                  <li class="animation gradient-border" id="box" data-animation="fadeInDown" data-animation-delay="1.8s"><a class="btn btn-white btn-radius nav_item" 
target="_blank" href="https://www.zircash.io/airdrop/">AirDrop</a></li>
                @auth
                    ...
                    <li class="animation" data-animation="fadeInDown" data-animation-delay="2.2s"><a class="nav-link nav_item" href="https://www.zircash.io/register/zircash">Sign Up</a></li>
                        @endauth
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 order-lg-first">
                <div class="banner_text_s2">
                    ...
                    <div class="btn_group animation" data-animation="fadeInUp" data-animation-delay="1.4s"> 
                        <a href="https://www.zircash.io/assets/frontlending/zircash.pdf" target="_blank" class="btn btn-default btn-radius page-scroll"><i class="fa fa-file-word-o"></i>Whitepaper</a> 
                        <a href="https://www.zircash.io/register/zircash" class="btn btn-border-white btn-radius">Sign Up To Join <i class="ion-ios-arrow-thin-right"></i></a> 
                    </div>
                    <div class="vertical_social">
    	<ul class="list_none d-flex d-lg-block">
        	<li><a href="https://www.linkedin.com/company/zircash/" target="_blank"><i class="fab fa-linkedin-in" ></i></a></li>
            <li><a href="https://twitter.com/Zircash_ZRS" target="_blank"><i class="fab fa-twitter"></i></li>
              <li><a href="https://etherscan.io/token/0x302eb72befc8af539432ec32c39423525412748f" target="_blank"><img src="assets/images/etherscan.png" style="max-width:25px;max-height:25px;"></li>
            <li><a href="https://github.com/ZIRCASH" target="_blank"><i class="fab fa-github"></i></a></li>
            <li><a href="https://medium.com/zircash" target="_blank"><i class="fab fa-medium-m"></i></a></li>
             <li><a href="https://www.youtube.com/watch?v=J9by14mfJPI" target="_blank"> <i class="fab fa-youtube-square"></i></a></li>
                ...
                <div class="banner_inner res_md_mb_50 res_xs_mb_30">
                    <div class="tk_countdown v_royal_blue  v_royal_blue banner_inner   text-center animation" data-animation="fadeIn" data-animation-delay="1.1s">
                        <div class="banner_text tk_counter_inner">
                            <h3><font face="verdana" color="#fff" >MAINSALE</font></h3>
                        <h4><font face="verdana" color="#fff" >CLOSING ON 10<sup>th</sup> Dec 2018</font></h4>
                            <div class="tk_countdown_time p-0 transparent_bg box_shadow_none animation" data-animation="fadeInUp" data-animation-delay="1.2s" data-time="2018/12/10 00:00:00"></div>
                            <div class="progress animation" data-animation="fadeInUp" data-animation-delay="1.3s">
                            <div class="progress-bar progress-bar-striped gradient" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:{{$front->ban_sold*100/3000000}}%">  </div>
                                <span class="progress_label bg-white" style="left: {{$front->ban_sold*100/3000000 }}%"> <strong> {{$front->ban_sold}} ZRS</strong></span>
                                <span class="progress_label bg-white" style="left: 100%"> <strong></strong></span>
                                <span class="progress_min_val">Sale Raised</span>
                                <span class="progress_max_val">3M Token</span>
                            </div>
                        	<a href="https://www.zircash.io/register/zircash" class="btn btn-default btn-radius animation" data-animation="fadeInUp" data-animation-delay="1.40s" >Get Registered <i class="ion-ios-arrow-thin-right"></i></a>
                            <ul class="icon_list list_none d-flex justify-content-center">
                                <li class="animation" data-animation="fadeInUp" data-animation-delay="1.7s"><i class="fab fa-btc"></i></i></li>
                                <li class="animation" data-animation="fadeInUp" data-animation-delay="1.8s"><i class="fab fa-ethereum"></i></li>
                                <li class="animation" data-animation="fadeInUp" data-animation-delay="1.8s"><img src="assets/images/logo/litecoin.svg" style="max-width:20px;max-height:20px;margin-top:-3px"></li>
                            </ul>                        
                        </div>
                	</div>
                </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
            	<div class="text-center res_md_mb_30 res_sm_mb_20">
                    ...
                    <div class="video_text">
                    	<a  href="https://www.youtube.com/watch?v=J9by14mfJPI" target="_blank">
        	...
        	<div class="col-xl-5 col-lg-5 col-md-5 col-sm-5">
            	<div class="bonus_box2 bonus_text_white bg-white-tran radius_box text-center animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                    ...
                    <div class="bonus_info">
                        ...
                        <a href="https://www.zircash.io/register/zircash">Join Now</a>
                    </div>
                </div>
            </div>
		</div>
...
<section>
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 res_md_mb_40">
                <div class="title_cyan_dark text-center">
...
<section id="team" class="team_box_s1 ">
       ...
       <div class="row">
          <div class="col-lg-8 col-md-12 offset-lg-2">
            <div class="title_cyan_dark text-center">
              ...
              <p class="animation" data-animation="fadeInUp" data-animation-delay="0.4s">We are proud of our great team. They are the most motivated and enthusiastic people we have, and are always ready and willing to help out whenever needed. </p>
            </div>
          </div>
        </div>
   ...
   <div class="divider large_divider"></div>-->
        <div class="row">
          <div class="col-md-12">
            <div class="title_cyan_dark text-center">
              <!--<h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.2s">Team</h4>-->
            </div>
          </div>
        </div>
        <div class="row small_space justify-content-center">
          <div class="col-lg-9 col-md-12">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-6 res_md_mb_30 res_sm_mb_20">
                <div class="team_box animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                    <div class="team_img rounded_img gradient_box text-center"> 
                    	<img src="assets/frontlending/images/team_01.jpg" alt="team5"/>
                    	<div class="social_team list_none">
                        <ul>
                    ...
                    <div class="team_info text-center">
                        <h4><!--<a href="#team5" class="content-popup">--><font color="#fff">Abela A</font></h4>
                        <p>Moderator</p>
                    </div>
                    <div id="team5" class="team_pop mfp-hide">
                        <div class="row m-0">
                            <div class="col-md-4 text-center"> 
                            	<div class="team_img_wrap">
                                	<img class="w-100" src="assets/frontlending/images/team_01.jpg" alt="user_img-lg"/>
                                    <div class="team_title"> 
                                        <h4>Abela A</h4>
                                        <span>Moderator</span>
                                    </div> 
                            ...
                            <div class="col-md-8">
                                <div class="pt-3">
                                    <h5>About</h5>
                                    <hr>
                                    <p>Women in crypto. I am an ICO driver, creative thinker and problem solver with an entrepreneurial spirit.</p>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 res_md_mb_30 res_sm_mb_20">
                <div class="team_box animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                    <div class="team_img rounded_img gradient_box text-center"> 
                    	<img src="assets/frontlending/images/team_03.jpg" alt="team6"/>
                    	<div class="social_team list_none">
                        <ul>
                    ...
                    <div class="team_info text-center">
                        <h4><!--<a href="#team6" class="content-popup">--><font color="#fff">Zen D</font></h4>
                        <p>Community Manger</p>
                    </div>
                    <div id="team6" class="team_pop mfp-hide">
                        <div class="row m-0">
                            <div class="col-md-4 text-center"> 
                            	<div class="team_img_wrap">
                                	<img class="w-100" src="assets/frontlending/images/team_03.jpg" alt="user_img-lg"/>
                                    <div class="team_title"> 
                                        <h4>Zen D</h4>
                                        <span>Community Manger</span>
                                    </div> 
                                </div>
                                <div class="social_single_team list_none mt-3">
                                        <ul>
              ...
              <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3 col-sm-6 offset-sm-3">
                <div class="team_box animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                    <div class="team_img rounded_img gradient_box text-center"> 
                    	<img src="assets/frontlending/images/team_02.jpg" alt="team7"/>
                    	<div class="social_team list_none">
                        <ul>
                    ...
                    <div class="team_info text-center">
                        <h4><font color="#fff">David smith</h4>
                    ...
                    <div id="team7" class="team_pop mfp-hide">
                        <div class="row m-0">
                            <div class="col-md-4 text-center"> 
                            	<div class="team_img_wrap">
                                	<img class="w-100" src="assets/frontlending/images/team_02.jpg" alt="user_img-lg"/> 
                                	<div class="team_title"> 
                                        <h4>David smith</h4>
            ...
            <div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3 col-sm-6 offset-sm-3">
                <div class="team_box animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                    <div class="team_img rounded_img gradient_box text-center"> 
                    	<img src="assets/frontlending/images/team_4.jpg" alt="team7"/>
                    	<div class="social_team list_none">
                        <ul>
                    ...
                    <div class="team_info text-center">
                        <h4><font color="#fff">Emiley bay</font></h4>
                        <p>ICO advisor</p>
                    </div>
             ...
             <div id="team6" class="team_pop mfp-hide">
                        <div class="row m-0">
                            <div class="col-md-4 text-center"> 
                            	<div class="team_img_wrap">
                                	<img class="w-100" src="assets/frontlending/images/team_4.jpg" alt=""/>
                                    <div class="team_title"> 
                                        <h4>Emiley bay</h4>
                                        <span>ICO advisor</span>
                                    </div> 
                                </div>
                                <div class="social_single_team list_none mt-3">
                                        <ul>
                            ...
                            <div id="accordion1" class="faq_content4">
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                                  ...
                                  <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion1">
                                    <div class="card-body"> The best cryptocurrency to buy is one we are willing to hold onto even if it goes down. For example, I believe in Zircash enough that I am willing to hold it even if it goes down i would start buying more of it if the price dropped.</div>
                                  </div>
                                </div>
                                ...
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="1s">
                                  ...
                                  <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion1">
                                    <div class="card-body"> Before Zircash I was in another altcoin and really excited about it. When I first bought the price was low and made payments to me every week just for holding it. As I tried to participate in the community over the next several months, I consistently met with a mix of excitement and hostility. When I began talking openly about this, the negative emotions won over in the community and in me. Originally I had invested and been happy to hold no matter what the price which quickly went up after I bought it. </div>
                                  </div>
                                </div>
                          </div>
                        </div>
                            ...
                            <div id="accordion2" class="faq_content4">
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                                  <div class="card-header" id="headingFive">
                                    <h6 class="mb-0"> <a data-toggle="collapse" href="#collapseFive" aria-expanded="true" aria-controls="collapseFive">How does one acquire zircash?</a> </h6>
                                  </div>
                                  <div id="collapseFive" class="collapse show" aria-labelledby="headingFive" data-parent="#accordion2">
                                    <div class="card-body"> While it may be possible to find individuals who wish to sell zircash in exchange for a credit card or PayPal payment, most exchanges do not allow funding via these payment methods. This is due to cases where someone buys zircash with PayPal, and then reverses their half of the transaction. This is commonly referred to as a chargeback.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                                  <div class="card-header" id="headingSix">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseSix" aria-expanded="false" aria-controls="collapseSix">Can I make money with zircash?</a> </h6>
                                  </div>
                                  <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion2">
                                    <div class="card-body"> You should never expect to get rich with zircash or any emerging technology. It is always important to be wary of anything that sounds too good to be true or disobeys basic economic rules.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                                  <div class="card-header" id="headingSeven">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">What happens when zircash are lost?</a> </h6>
                                  </div>
                                  <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion2">
                                    <div class="card-body">When a user loses his wallet, it has the effect of removing money out of circulation. Lost zircash still remain in the block chain just like any other zircash. However, lost zircash remain dormant forever because there is no way for anybody to find the private key(s) that would allow them to be spent again. Because of the law of supply and demand, when fewer zircash are available, the ones that are left will be in higher demand and increase in value to compensate.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="1s">
                                  <div class="card-header" id="headingEight">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseEight" aria-expanded="false" aria-controls="collapseEight">Who controls the zircash network?</a> </h6>
                                  </div>
                                  <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion2">
                                    <div class="card-body">Nobody owns the zircash network much like no one owns the technology behind email. zircash is controlled by all zircash users around the world. While developers are improving the software, they can't force a change in the zircash protocol because all users are free to choose what software and version they use.</div>
                                  </div>
                                </div>
                          </div>	
                        </div>
                            ...
                            <div id="accordion3" class="faq_content4">
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                                  <div class="card-header" id="headingNine">
                                    <h6 class="mb-0"> <a data-toggle="collapse" href="#collapseNine" aria-expanded="true" aria-controls="collapseNine">How are zircash created?</a> </h6>
                                  </div>
                                  <div id="collapseNine" class="collapse show" aria-labelledby="headingNine" data-parent="#accordion3">
                                    <div class="card-body"> New zircash are generated by a competitive and decentralized process called "mining". This process involves that individuals are rewarded by the network for their services. zircash miners are processing transactions and securing the network using specialized hardware and are collecting new zircash in exchange.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                                  <div class="card-header" id="headingTen">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseTen" aria-expanded="false" aria-controls="collapseTen">Why do zircash have value?</a> </h6>
                                  </div>
                                  <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordion3">
                                    <div class="card-body">zircash have value because they are useful as a form of money. zircash has the characteristics of money (durability, portability, fungibility, scarcity, divisibility, and recognizability) based on the properties of mathematics rather than relying on physical properties (like gold and silver) or trust in central authorities (like fiat currencies). In short, zircash is backed by mathematics. </div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                                  <div class="card-header" id="headingEleven">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">What determines zircash's price?</a> </h6>
                                  </div>
                                  <div id="collapseEleven" class="collapse" aria-labelledby="headingEleven" data-parent="#accordion3">
                                    <div class="card-body"> The price of a zircash is determined by supply and demand. When demand for zircash increases, the price increases, and when demand falls, the price falls. There is only a limited number of zircash in circulation and new zircash are created at a predictable and decreasing rate</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="1s">
                                  <div class="card-header" id="headingTwelve">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">Can zircash become worthless?</a> </h6>
                                  </div>
                            ...
                            <div id="accordion4" class="faq_content4">
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                                  <div class="card-header" id="headingThirteen">
                                    <h6 class="mb-0"> <a data-toggle="collapse" href="#collapseThirteen" aria-expanded="true" aria-controls="collapseThirteen">Is zircash legal?</a> </h6>
                                  </div>
                                  <div id="collapseThirteen" class="collapse show" aria-labelledby="headingThirteen" data-parent="#accordion4">
                                    <div class="card-body">To the best of our knowledge, zircash has not been made illegal by legislation in most jurisdictions. However, some jurisdictions (such as Argentina and Russia) severely restrict or ban foreign currencies. Other jurisdictions (such as Thailand) may limit the licensing of certain entities such as zircash exchanges.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                                  <div class="card-header" id="headingFourteen">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseFourteen" aria-expanded="false" aria-controls="collapseFourteen">Is zircash useful for illegal activities?</a> </h6>
                                  </div>
                                  <div id="collapseFourteen" class="collapse" aria-labelledby="headingFourteen" data-parent="#accordion4">
                                    <div class="card-body">zircash is money, and money has always been used both for legal and illegal purposes. Cash, credit cards and current banking systems widely surpass zircash in terms of their use to finance crime. zircash can bring significant innovation in payment systems and the benefits of such innovation are often considered to be far beyond their potential drawbacks.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                                  <div class="card-header" id="headingFifteen">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseFifteen" aria-expanded="false" aria-controls="collapseFifteen">Can zircash be regulated?</a> </h6>
                                  </div>
                                  <div id="collapseFifteen" class="collapse" aria-labelledby="headingFifteen" data-parent="#accordion4">
                                    <div class="card-body"> The zircash protocol itself cannot be modified without the cooperation of nearly all its users, who choose what software they use. Attempting to assign special rights to a local authority in the rules of the global zircash network is not a practical possibility.</div>
                                  </div>
                                </div>
                                <div class="card animation" data-animation="fadeInUp" data-animation-delay="1s">
                                  <div class="card-header" id="headingSixteen">
                                    <h6 class="mb-0"> <a class="collapsed" data-toggle="collapse" href="#collapseSixteen" aria-expanded="false" aria-controls="collapseSixteen">What about zircash and taxes?</a> </h6>
                                  </div>
                                  <div id="collapseSixteen" class="collapse" aria-labelledby="headingSixteen" data-parent="#accordion4">
                                    <div class="card-body"> zircash is not a fiat currency with legal tender status in any jurisdiction, but often tax liability accrues regardless of the medium used. There is a wide variety of legislation in many different jurisdictions which could cause income, sales, payroll, capital gains, or some other form of tax liability to arise with zircash.</div>
                                  </div>
                                </div>
                          </div>	
                        </div>
	...
	<div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
            	<div class="title_cyan_dark">
                    <h4 class="animation mb-3" data-animation="fadeInUp" data-animation-delay="0.2s">Connect With Us</h4>
                    <p class="animation" data-animation="fadeInUp" data-animation-delay="0.4s">If You have any questions? we are happy to help</p>
                </div>
            </div>
        </div>
        <div class="row small_space">
            <div class="col-lg-8 col-md-8">
                <form method="post" name="email_form" class="field_form">
                    <div class="row">
                        <div class="form-group col-md-6 animation" data-animation="fadeInUp" data-animation-delay="0.4s">
                            <input type="text" required="required" placeholder="Enter First Name *" id="first-name" class="form-control" name="fname">
                         </div>
                          <div class="form-group col-md-6 animation" data-animation="fadeInUp" data-animation-delay="0.6s">
                            <input type="text" required="required" placeholder="Enter Last Name *" id="last-name" class="form-control" name="lname">
                         </div>
                        ...
                        <div class="form-group col-md-6 animation" data-animation="fadeInUp" data-animation-delay="1.0s">
			...
			<div class="row">
                ...
                <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-8 res_md_mt_30 res_sm_mt_20">
                    ...
                    <ul class="footer_link half_link list_none">
                    	<li class="animation" data-animation="fadeInUp" data-animation-delay="0.2s"><a class="page-scroll" href="{{route('login')}}">Login</a></li>
                ...
                <div class="col-lg-2 offset-lg-1 col-md-6 col-sm-4 res_md_mt_30 res_sm_mt_20">
                    ...
                    <ul class="footer_social list_none">
                        ...
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.3s"><a href="https://twitter.com/Zircash_ZRS" target="_blank"><i class="ion-social-twitter"></i> Twitter</a></li>
                        
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.5s"><a href="https://www.linkedin.com/company/zircash/" target="_blank"><i class="ion-social-linkedin"></i> Linkedin</a></li>
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.6s"><a href="https://www.youtube.com/watch?v=J9by14mfJPI" target="_blank"><i class="ion-social-youtube-outline"></i> youtube</a></li>
                        <li class="animation" data-animation="fadeInUp" data-animation-delay="0.7s"><a href="https://github.com/ZIRCASH" target="_blank"><i class="ion-social-github"></i> Github</a></li>
...
<script>
  $(document).ready(function(){<!-- START LOADER -->
<div id="loader-wrapper">
    <div id="loading-center-absolute">
        <div class="object" id="object_four"></div>
        <div class="object" id="object_three"></div>
...
<!-- Latest jQuery --> 
<script src="{{asset('assets/frontlending/js/jquery-1.12.4.min.js')}}"></script> 
<!-- Latest compiled and minified Bootstrap --> 
<script src="{{asset('assets/frontlending/js/popper.min.js') }}"></script>
<script src="{{asset('assets/frontlending/bootstrap/js/bootstrap.min.js') }}"></script> 
<!-- owl-carousel min js  --> 
<script src="{{asset('assets/frontlending/owlcarousel/js/owl.carousel.min.js') }}"></script> 
<!-- magnific-popup min js  --> 
<script src="{{asset('assets/frontlending/js/magnific-popup.min.js') }}"></script> 
<!-- waypoints min js  --> 
<script src="{{asset('assets/frontlending/js/waypoints.min.js') }}"></script> 
<!-- parallax js  --> 
<script src="{{asset('assets/frontlending/js/parallax.js') }}"></script> 
<!-- countdown js  --> 
<script src="{{asset('assets/frontlending/js/jquery.countdown.min.js') }}"></script> 
<!-- particles min js  --> 
<script src="{{asset('assets/frontlending/js/particles.min.js') }}"></script> 
<!-- scripts js --> 
<script src="{{asset('assets/frontlending/js/jquery.dd.min.js') }}"></script> 
<!-- jquery.counterup.min js --> 
<script src="{{asset('assets/frontlending/js/jquery.counterup.min.js') }}"></script>
<!-- jquery.wavify js -->  
<script src="{{asset('assets/frontlending/js/spop.min.js') }}"></script> 
<!-- scripts js --> 
<script src="{{asset('assets/frontlending/js/scripts.js') }}"></script>
<script>
