        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{route('sendemailver')}}" method="POST">
              {{csrf_field()}}
              <button type="submit" class="btn btn-lg btn-block btn-primary" onclick="myFunction()">Click here to Send Verification Code</button>
             </br><p style="color:#AD2103";>"MISSING EMAILS! HAVE YOU CHECKED YOUR SPAM FOLDER?"</p>
