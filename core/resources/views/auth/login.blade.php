          ...
          <div class="card-body">
            ...
            <form  method="POST" action="{{ route('login') }}">
              ...
              <div class="form-group">
                ...
                <input id="username" class="form-control" type="text" name="username" value="{{ old('username') }}" placeholder="User name" required autofocus>
            ...
            <div class="text-center mt-3 justify-content-between d-md-flex">
              <a class="d-block small" href="https://www.zircash.io/register/zircash">Register an Account</a>
