    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            @if(request()->path() == 'admin/users') active open
                ...
                @elseif(request()->path() == 'admin/transaction-log') active open
            @endif">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item @if(request()->path() == 'admin/document') active open @endif">
                    <a href="{{route('document.requests')}}" class="nav-link ">
                        <i class="icon-docs"></i>
                        <span class="title">KYC Request</span>
                    </a>
                </li> 
        ...
        <li class="nav-item @if(request()->path() == 'admin/referral-list') active open @endif">
            ...
            <li class="nav-item  @if(request()->path() == 'admin/gateway') active open @endif">
              ...
              <li class="nav-item  @if(request()->path() == 'admin/sell-log') active open @endif">
                <a href="{{route('sellLog')}}" class="nav-link nav-toggle">
                    ...
                    <span class="title">ICO Sell Log</span>
                </a>
            </li> 
            ...
            <li class="nav-item  @if(request()->path() == 'admin/transaction-log') active open @endif">
                <a href="{{route('transactionLog')}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item @if(request()->path() == 'admin/package') active open
            @elseif(request()->path() == 'admin/lending-log') active open
            @endif">
                ...
                <ul class="sub-menu">
                    <li class="nav-item @if(request()->path() == 'admin/package') active open @endif">
                        <a href="{{route('package')}}" class="nav-link ">
                            <i class="fa fa-cog"></i>
                            <span class="title">Lending Packages</span>
                        </a>
                    </li>
                    <li class="nav-item @if(request()->path() == 'admin/lending-log') active open @endif">
                        <a href="{{route('lend.log')}}" class="nav-link ">
                            <i class="fa fa-list"></i>
            ...
            <li ><a href="https://www.zircash.io/support/admin" target="_blank"><i class="fa fa-life-ring" aria-hidden="true"></i> <span>Support</span></a></li>
            ...
            @elseif(request()->path() == 'admin/prices') active open 
            @endif">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="fa fa-cogs"></i>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item @if(request()->path() == 'admin/prices') active open @endif">
                        <a href="{{route('price.index')}}" class="nav-link ">
                            <i class="fa fa-usd"></i>
                            <span class="title">{{$gnl->cur}} Prices</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            @elseif(request()->path() == 'admin/section') active open 
            @elseif(request()->path() == 'admin/section/create') active open 
            ...
            @endif">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item @if(request()->path() == 'admin/social') active open @endif">
                     ...
                     <li class="nav-item @if(request()->path() == 'admin/section') active open
                        @elseif(request()->path() == 'admin/section/create') active open 
                      @endif">
                        <a href="{{route('section.index')}}" class="nav-link ">
                            <i class="fa fa-cog"></i>
                            <span class="title">Custom Section</span>
                        </a>
                    </li>
                </ul>
            </li>
