  ...
  <div data-scrollbar="true" data-height="100%">
    <ul class="nav text-center">
      <li class="nav-profile">
        <div class="info text-center">
          ...
          <a href="{{route('profile')}}" style="text-decoration: none; font-size: 15px; color: #ddd;">{{Auth::user()->name}}@if(Auth::user()->docv != '0') <i class="fa fa-check-circle" style="color:#3396FF"></i> @endif</a>
    ...
    <ul class="nav" style="text-transform: uppercase;">
      ...
      @if($gnl->transaction==1)
       ...
       <li class="@if(request()->path() == 'home/buy-ico') active @endif"><a href="{{route('buy.ico')}}"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Purchase {{$gnl->cur}}</span></a></li>
      @endif
      <li class="has-sub @if(request()->path() == 'home/withdraw-zir') active 
          @elseif(request()->path() == 'home/withdraw-log') active 
            @endif" >
            <a href="javascript:;">
                <b class="caret pull-right"></b>
                <i class="fa fa-share"></i>
                <span>Withdraw {{$gnl->cur}}</span>
            </a>
            <ul class="sub-menu">
               <li class="@if(request()->path() == 'home/withdraw-zir') active @endif"><a href="{{route('user.withdrawbtc')}}"><i class="fa fa-share" aria-hidden="true"></i> <span>Withdraw </span></a>
              </li> 
              <li class="@if(request()->path() == 'home/withdraw-log') active @endif"><a href="{{route('user.withlog')}}"><i class="fa fa-list" aria-hidden="true"></i> <span>WithdrawLog</span></a>
              </li>
          </ul>
        </li>
      @if($gnl->lending==1)
      ...
      @endif
       @if(Auth::user()->docv != '1')
            <li ><a href="{{route('document')}}"><i class="fa fa-file-text" aria-hidden="true"></i> <span>Submit KYC</span></a></li>
       @endif
       <li ><a href="https://www.zircash.io/support" target="_blank"><i class="fa fa-life-ring" aria-hidden="true"></i> <span>Support</span></a></li>
