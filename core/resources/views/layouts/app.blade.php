...
<html>
    <head>
        ...
        <!--font-awesome Css-->
        <link href="{{asset('assets/app/css/font-awesome.min.css') }}" rel="stylesheet">
        <!--owl.carousel Css-->
        <link href="{{asset('assets/app/css/owl.carousel.min.css') }}" rel="stylesheet">
        <!--Slick Nav Css-->
        <link href="{{asset('assets/app/css/slicknav.min.css') }}" rel="stylesheet">
        <!--Animate Css-->
        <link href="{{asset('assets/app/css/animate.css') }}" rel="stylesheet">
        <!--Magnitic popup Css-->
        <link href="{{asset('assets/app/css/magnific-popup.css') }}" rel="stylesheet">
        <!--Style Css-->
        <link href="{{asset('assets/app/css/style.css') }}" rel="stylesheet">
        <link href="{{asset('assets/app/css/color.css') }}" rel="stylesheet">
              <link href="{{asset('assets/app/css/color.php?color=') }}{{$gnl->color}}" rel="stylesheet">
        <!--Responsive Css-->
        <link href="{{asset('assets/app/css/responsive.css') }}" rel="stylesheet">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 text-right ">     
                    <ul id="main-menu" >
                        ...
                        <li><a href="https://www.zircash.io/register/zircash">Sign Up</a></li>
                        @endauth
                    </ul>
                </div>   
            </div>
...
<!--preloader end-->
    ...
    <!--back to top end-->
        ...
        <script src="{{asset('assets/app/js/scrollspy.min.js') }}"></script>
        <!--Wow Js File Load-->
