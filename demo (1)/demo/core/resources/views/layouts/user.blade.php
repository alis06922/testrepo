...
<img class="img-responsive" src="{{ asset('assets/images/logo/logo.png') }}" style="max-width: 68%; ">
</a>
...
<ul class="nav navbar-nav navbar-right">
    <li class="dropdown">
        <a href="#" style="font-size: 20px; color:#fff; margin-right: 20px;">BALANCE = {{round($balance , $gnl->decimal)}} {{$gnl->cur}}</a>
    </li>
    <li class="dropdown">
        <a href="#" style="font-size: 20px; color:#fff; margin-right: 20px;">1 {{$gnl->cur}} = {{round($price , $gnl->decimal)}} USD</a>
    </li>
</ul>
